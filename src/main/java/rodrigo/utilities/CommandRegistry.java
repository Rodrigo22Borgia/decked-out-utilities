                                ...
                                .then(Commands.argument("ID", IntegerArgumentType.integer(0))
                                        ...
                                        .then(Commands.argument("type", StringArgumentType.word()).suggests((context, builder) -> builder
                                                ...
                                                .then(Commands.literal("multiplier")
                                                        .then(Commands.argument("multiple", StringArgumentType.word()).suggests((context, builder) -> builder
                                                                        .suggest("none")
                                                                        .suggest("x2")
                                                                        .suggest("_2")
                                                                        .suggest("get")
                                                ...
                                                .then(Commands.literal("increment").executes(context -> {final int val = getMap(context).increment(context); context.getSource().sendSuccess(() -> Component.literal("" + val), false); return val;}))
                                                .then(Commands.literal("decrement").executes(context -> {final int val = getMap(context).decrement(context); context.getSource().sendSuccess(() -> Component.literal("" + val), false); return val;}))
